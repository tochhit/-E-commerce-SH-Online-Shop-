...
class VariationController extends GetxController {
  ...
  /// Check If selected attributes matches any variation attributed
  ...
  Set<String?> getAttributesAvailabilityInVariation(List<ProductVariationModel> variations, String attributeName) {
    // Pass the variations to check which attributes are available and stick is not 0
  ...
  void getProductVariationStockStatus() {
    variationStockStatus.value = selectedVariation.value.stock > 0 ? 'In Stock' : 'Out to Stock';
  }
