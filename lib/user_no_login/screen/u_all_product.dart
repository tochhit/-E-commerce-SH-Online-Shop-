...
class UAllProducts extends StatefulWidget {
  const UAllProducts({Key? key, required this.title, this.query, this.futureMethod});
...
class _AllProductsState extends State<UAllProducts> {
